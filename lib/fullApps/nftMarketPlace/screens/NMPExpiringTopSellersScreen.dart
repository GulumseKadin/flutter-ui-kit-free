                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(moreFromCollection[index].subtitle!,
                              overflow: TextOverflow.ellipsis, maxLines: 2, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                        ),
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 8.0),
                          width: 182,
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  commonCachedNetworkImage('$osImageBaseUrl/icons/os_ic_token.png',
                                      width: 17, height: 17, alignment: Alignment.topCenter, color: Theme.of(context).iconTheme.color),
                                  Text(moreFromCollection[index].price.toString(),
                              ...
                              IconButton(
                                icon: Row(
                                  children: [
                                    Icon(moreFromCollection[index].isSelected ? Icons.favorite : Icons.favorite_outline,
                                        color: moreFromCollection[index].isSelected ? Colors.red : null, size: 20),
                                    SizedBox(width: 8),
                                    Expanded(
                                        child: Text(moreFromCollection[index].like.toString(), style: TextStyle(fontSize: 12, color: Colors.grey))),
                                  ],
                                ),
                                onPressed: () {
                                  String s = '';
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: TextField(
                                                                ...
                                                                decoration: InputDecoration(
                                                                  ...
                                                                  hintStyle:
                                                                      TextStyle(color: Theme.of(context).textTheme.titleMedium!.color, fontSize: 14),
                                                                  hintText: "Address",
