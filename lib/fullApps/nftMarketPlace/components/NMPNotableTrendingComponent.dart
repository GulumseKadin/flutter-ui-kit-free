        ...
        children: [
          ...
          Padding(
            ...
            child: Text(widget.dataModel.subtitle!,
                overflow: TextOverflow.ellipsis, maxLines: 1, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  icon: Row(
                    children: [
                      Icon(widget.dataModel.isSelected ? Icons.favorite : Icons.favorite_outline,
                          color: widget.dataModel.isSelected ? Colors.red : null, size: 20),
                      SizedBox(width: 8),
                      Expanded(
                          child: Text(widget.dataModel.like.toString(),
                              overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12, color: Colors.grey))),
                    ],
                  ),
                  onPressed: () {
                    String s = '';
