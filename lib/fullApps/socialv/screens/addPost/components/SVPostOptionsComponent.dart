...
class _SVPostOptionsComponentState extends State<SVPostOptionsComponent> {
  List<String> list = ['$BaseUrl/images/socialv/posts/post_one.png', '$BaseUrl/images/socialv/posts/post_two.png', '$BaseUrl/images/socialv/posts/post_three.png', '$BaseUrl/images/socialv/postImage.png'];
