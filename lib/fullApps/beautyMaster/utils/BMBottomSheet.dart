                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(element.time,style: secondaryTextStyle(color: appStore.isDarkModeOn ? bmTextColorDarkMode : bmPrimaryColor),)
                    ],
                  ),
                  AppButton(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            if(form_key.currentState!.validate() && comment.text != ''){
                              list.add(BMCommentModel(isSubComment: false,isLiked: false,likes: '0',name: 'You',message: comment.text,time: 'just now',image: '$BaseUrl/images/beauty_master/face_two.jpg'));
                              setState((){});
                            }
                          },
                        ),
