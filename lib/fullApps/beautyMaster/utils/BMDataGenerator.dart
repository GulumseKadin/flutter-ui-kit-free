...
List<WalkThroughModelClass> getWalkThroughList() {
  ...
  list.add(
      WalkThroughModelClass(image: 'images/beauty_master/model_three.jpg', title: 'Book anytime, anywhere', subTitle: 'Access calenders, services, and reviews wuth the freedom to book as you please.'));
...
List<BMCommentModel> getCommentsList() {
  ...
  list.add(BMCommentModel(image: '$BaseUrl/images/beauty_master/face_two.jpg', likes: '2', time: '3m', name: 'Roxie Love', message: 'How many time for this style?', isSubComment: false, isLiked: true));
  ...
  list.add(BMCommentModel(image: '$BaseUrl/images/beauty_master/face_one.png', likes: '4', time: '2d', name: 'Cvita Dolwschall', message: 'Suite with me, let\'s go!', isSubComment: false, isLiked: false));
...
List<BMMessageModel> getMessageList() {
  ...
  list.add(BMMessageModel(image: '$BaseUrl/images/beauty_master/face_two.jpg', name: 'Hannah Benson', message: 'Hello!', isActive: true, lastSeen: ''));
  list.add(BMMessageModel(image: '$BaseUrl/images/beauty_master/face_one.png', name: 'Victor Pocheco', message: 'Do you want to confirm yor appointment?', isActive: false, lastSeen: 'today , at 11:30 am'));
