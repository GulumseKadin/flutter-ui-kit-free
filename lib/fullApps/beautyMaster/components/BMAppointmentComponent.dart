  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: widget.element.isSelected ?  appStore.isDarkModeOn ? Colors.white.withAlpha(30) : bmSpecialColorDark.withAlpha(30) : context.cardColor,
        borderRadius: radius(32),
        border: Border.all(color: widget.element.isSelected ? appStore.isDarkModeOn ? Colors.white : bmSpecialColorDark : context.cardColor),
      ),
      child: Row(
