              ...
              children: [
                Column(
                  children: [
                    ...
                    Text('Location', style: primaryTextStyle(color: isLocation ? LSColorPrimary : appStore.isDarkModeOn ? white: black)),
                  ],
                ).onTap(() {
                  isLocation = true;
                  isDateTime = false;
                ...
                Column(
                  children: [
                    ...
                    Text('DateTime', style: primaryTextStyle(color: isDateTime ? LSColorPrimary : appStore.isDarkModeOn ? white: black)),
                  ],
                ).onTap(() {
                  isLocation = true;
                  isDateTime = true;
                ...
                Column(
                  children: [
                    ...
                    Text('Payment', style: primaryTextStyle(color: isPayment ? LSColorPrimary : appStore.isDarkModeOn ? white: black)),
                  ],
                ).onTap(() {
                  isLocation = true;
                  isDateTime = true;
                ...
                Column(
                  children: [
                    ...
                    Text('Complete', style: primaryTextStyle(color: isComplete ? LSColorPrimary : appStore.isDarkModeOn ? white: black)),
                  ],
                ).onTap(() {
                  isLocation = true;
                  isDateTime = true;
