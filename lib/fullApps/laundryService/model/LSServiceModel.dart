...
List<LSServiceModel> getBookingList() {
  ...
  list.add(LSServiceModel(
      title: 'Dhobee Laundry', amount: '474', status: 'confirmed', orderNo: '1235786535', date: 'Wed, 15 June 2019, 11:35AM', location: '1810,Camino Real ,New-york'));
  list.add(
      LSServiceModel(title: 'My Laundry', amount: '123', status: 'picked up', orderNo: '4567865432', date: 'Fri, 19 June 2019, 10:05AM', location: '1810,Camino Real ,New-york'));
  list.add(LSServiceModel(
      title: 'Quick Laundry', amount: '345', status: 'In Progress', orderNo: '5643456765', date: 'Mon, 01 July 2019, 09:35AM', location: '1810,Camino Real ,New-york'));
  list.add(
      LSServiceModel(title: 'Your Laundry', amount: '654', status: 'Shipped', orderNo: '8766765432', date: 'Thus, 21 July 2019, 11:35AM', location: '1810,Camino Real ,New-york'));
  list.add(
      LSServiceModel(title: 'Dhobee Laundry', amount: '342', status: 'Delivered', orderNo: '1234234565', date: 'Sat, 05 Aug 2019, 1:05PM', location: '1810,Camino Real ,New-york'));
  list.add(
      LSServiceModel(title: 'My Laundry', amount: '179', status: 'completed', orderNo: '1239876543', date: 'Fri, 11 Sept 2019, 11:35AM', location: '1810,Camino Real ,New-york'));
  list.add(
      LSServiceModel(title: 'Quick Laundry', amount: '876', status: 'picked up', orderNo: '6547854389', date: 'Tus, 15 Oct 2019, 11:35AM', location: '1810,Camino Real ,New-york'));
  list.add(
      LSServiceModel(title: 'Your Laundry', amount: '650', status: 'Delivered', orderNo: '12345645678', date: 'Wed, 03 Nov 2019, 11:35AM', location: '1810,Camino Real ,New-york'));
  return list;
}
...
List<LSServiceModel> getNotificationList() {
  ...
  list.add(
    LSServiceModel(
        ...
        status: 'confirmed',
        date: '4hr ago',
        subTitle: 'Be ready! with your clothing\'s baggage between 04:00 PM to 06:00 PM on 29 nov 2020',
        img: LSDelivery),
  );
  list.add(
    LSServiceModel(
  ...
  list.add(
    LSServiceModel(
        ...
        status: 'delivered',
        date: '12 nov',
        subTitle: 'Delivery boy will reach to you between 12:00 PM to 02:00 PM on Monday. 10 nov 2021',
        img: LSShipping),
  );
  list.add(
      LSServiceModel(title: 'Your order is now in-process', status: 'in-process', date: '10 nov', subTitle: 'your order is in-process, it will be shipped within 48hrs.', img: LSInProgress));
  list.add(
    LSServiceModel(
