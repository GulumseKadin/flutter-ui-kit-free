...
class _WalkThroughModelScreenState extends State<WalkThroughModelScreen> {
  ...
  void init() {
    walkThroughList.add(WalkThroughModelClass(title: 'Personalized meal planning', subTitle: 'Pick your week\'s meal in minutes. With over 200 personalization options eat exactly how you want to eat.',image: 'images/mealime/walkthrough_one.png'));
    walkThroughList.add(WalkThroughModelClass(title: 'Simple, stress-free grocery shopping', subTitle: 'Grocery shop once per week with an organized "done for you" shopping list.',image: 'images/mealime/walkthrough_two.png'));
    walkThroughList.add(WalkThroughModelClass(title: 'Delicious healthy meals made easy', subTitle: 'Easily cook healthy, delicious meals in about 30 minutes, from start to finish.',image: 'images/mealime/walkthrough_three.png'));
  }
