          ...
          child: Row(
            ...
            children: fragmentList.map((e) {
              ...
              return Column(
                ...
                children: [
                  Image.asset(e.image,height: 26,width: 26,fit: BoxFit.cover,color: selectedTab == index ?  miaPrimaryColor : appStore.isDarkModeOn ? Colors.white54 : miaSecondaryColor),
                  Text(e.tab,style: secondaryTextStyle(color: selectedTab == index ?  miaPrimaryColor : appStore.isDarkModeOn ? Colors.white54 : miaSecondaryColor,size: 12))
                ],
              ).onTap((){
                selectedTab = index;
                setState(() {});
