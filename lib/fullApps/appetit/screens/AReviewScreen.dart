                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Container(
                              height: 60,
                              width: 60,
                              child: commonCachedNetworkImage('$BaseUrl/images/appetit/soup.jpg',
                          ...
                          ClipRRect(
                            ...
                            child: Container(
                              height: 60,
                              width: 60,
                              child: commonCachedNetworkImage('$BaseUrl/images/appetit/category4.jpg',
                                  fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                            ),
                          ),
                          SizedBox(width: 8),
                          ClipRRect(
                            ...
                            child: Container(
                              height: 60,
                              width: 60,
                              child: commonCachedNetworkImage('$BaseUrl/images/appetit/p1.jpg',
                                  fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                            ),
                          ),
                          SizedBox(width: 8),
                          ClipRRect(
                            ...
                            child: Container(
                              height: 60,
                              width: 60,
                              child: commonCachedNetworkImage('$BaseUrl/images/appetit/p2.jpg',
                                  fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                            ),
                          ),
                          SizedBox(width: 8),
                            ...
                            child: Stack(
                              children: [
                                Container(
                                  height: 60,
                                  width: 60,
                                  child: commonCachedNetworkImage('$BaseUrl/images/appetit/p3.jpg',
                                      fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                                ),
                                Container(
                                  height: 60,
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                          borderRadius: BorderRadius.circular(25),
                                          child: commonCachedNetworkImage(e.reviewpic.toString(),
