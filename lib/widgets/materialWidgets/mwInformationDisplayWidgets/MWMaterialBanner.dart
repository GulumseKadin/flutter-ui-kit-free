        ...
        body: AppButton(
          ...
          onTap: () {
            ScaffoldMessenger.of(context).showMaterialBanner(MaterialBanner(
              ...
              content: Text('Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content.', style: primaryTextStyle(color: Colors.white)),
              actions: <Widget>[
                TextButton(
