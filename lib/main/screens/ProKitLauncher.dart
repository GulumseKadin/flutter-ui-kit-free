          ...
          children: [
            Container(
              ...
              decoration: selectedTab == pos
                  ? BoxDecoration(color: appColorPrimary.withOpacity(0.1), borderRadius: isRight ? BorderRadius.only(topLeft: Radius.circular(16)) : BorderRadius.only(topRight: Radius.circular(16)))
                  : BoxDecoration(),
            ),
            Positioned(
              right: 20,
                              ...
                              SingleChildScrollView(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    category(appCat2, app_dashboard, snapshot.data!.dashboard!.name, type: snapshot.data!.dashboard!.tag, onTap: () {
