...
import 'package:prokit_flutter/integrations/screens/PaymetGatways/GoogleandApplePayScreen.dart';
import 'package:prokit_flutter/integrations/screens/PaymetGatways/PayStackScreen.dart';
import 'package:prokit_flutter/integrations/screens/PaymetGatways/StripePaymentScreen.dart';
...
import '../../widgets/materialWidgets/mwAppStrucutreWidgets/MWAppBarScreen.dart';
...
List<ProTheme> getThemes() {
  ...
  list.add(
      ProTheme(name: 'Diamond Kit', title_name: 'Theme 14 Screens', tag: '', show_cover: true, sub_kits: getDiamondKit(), darkThemeSupported: true));
  list.add(
      ProTheme(name: 'Real State', title_name: 'Theme 13 Screens', type: '', show_cover: true, sub_kits: getRealState(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Digital Wallet', title_name: 'Theme 12 Screens', type: '', show_cover: true, sub_kits: getDigitalWallet(), darkThemeSupported: true));
  list.add(ProTheme(
  ...
  list.add(
      ProTheme(name: 'E-commerce', title_name: 'Theme 10 Screens', type: '', show_cover: true, sub_kits: getECommerce(), darkThemeSupported: true));
  ...
  list.add(ProTheme(
      name: 'Hotel Booking', title_name: 'Theme 7 Screens', type: '', show_cover: true, sub_kits: getHotelBooking(), darkThemeSupported: true));
  ...
  list.add(
      ProTheme(name: 'Food Recipe', title_name: 'Theme 3 Screens', type: '', show_cover: true, sub_kits: getFoodRecipe(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Exercise Tips', title_name: 'Theme 2 Screens', type: '', show_cover: true, sub_kits: getExerciseTips(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'File Manager', title_name: 'Theme 1 Screens', type: '', show_cover: true, sub_kits: getFileManageScreens(), darkThemeSupported: true));
...
List<ProTheme> getScreenList() {
  List<ProTheme> list = [];
  list.add(
      ProTheme(name: 'Empty Screens', title_name: 'Empty screens', tag: '', show_cover: true, sub_kits: getEmptyScreens(), darkThemeSupported: true));
  list.add(
      ProTheme(name: 'Error Screens', title_name: 'Error Screens', tag: '', show_cover: true, sub_kits: getErrorScreens(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Custom Paint', title_name: 'Custom Paint Screens', tag: '', show_cover: true, sub_kits: getCustomPaints(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Pricing Plans', title_name: 'Pricing Plan Screens', tag: '', show_cover: true, sub_kits: getPricingPlans(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'WalkThrough', title_name: 'WalkThrough Screens', type: '', show_cover: true, sub_kits: getWalkThrough(), darkThemeSupported: true));
  ...
  list.add(
      ProTheme(name: 'Dashboard', title_name: 'Dashboard Screens', type: '', show_cover: true, sub_kits: getDashboard(), darkThemeSupported: true));
  list.add(
      ProTheme(name: 'Side Menu', title_name: 'Side Menu Screens', type: '', show_cover: true, sub_kits: getSideMenu(), darkThemeSupported: true));
  list.add(ProTheme(
      ...
      darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Detail Screen', title_name: 'Detail Screen Screens', type: '', show_cover: true, sub_kits: getDetailScreen(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Image Slider', title_name: 'Image Slider Screens', type: '', show_cover: true, sub_kits: getImageSlider(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Bottom Sheet', title_name: 'Bottom Sheet Screens', type: '', show_cover: true, sub_kits: getBottomSheet(), darkThemeSupported: true));
...
List<ProTheme> getCustomPaints() {
  ...
  list.add(ProTheme(
      name: 'Custom Temperature', is_theme: true, tag: 'New', widget: TemperatureWidgetScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
ProTheme getDashboards() {
  ProTheme theme = ProTheme(sub_kits: [], name: 'Dashboards', title_name: 'Dashboard Screens', show_cover: true, type: '');
  List<ProTheme> list = [];
...
ProTheme getFullApps() {
  ...
  list.add(ProTheme(name: 'Appetit', tag: 'New', widget: ASplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'NFT Market Place', tag: 'New', widget: NMPSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Snagajob', tag: 'New', widget: JSSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Juber Taxi', tag: 'New', widget: JCBSplashScreen(), darkThemeSupported: true));
  ...
  list.add(ProTheme(name: 'Sneaker Shoppin', tag: '', widget: SSSplashScreen(), darkThemeSupported: true));
...
ProTheme getWidgets() {
  ...
  list.add(
      ProTheme(name: 'Material Widgets', tag: '', show_cover: false, sub_kits: getMaterialWidgets(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Cupertino Widgets', type: '', show_cover: false, sub_kits: getCupertinoWidgets(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
List<ProTheme> getMaterialWidgets() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'App Structure', show_cover: false, type: '', tag: '', sub_kits: getAppStructure(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Buttons', show_cover: false, type: '', sub_kits: getButtons(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Input & Selection', show_cover: false, type: '', sub_kits: getInputSelection(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
List<ProTheme> getBottomNavigationBar() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'With Icon and Label', show_cover: false, type: '', widget: MWBottomNavigationScreen1(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'With Custom Image', show_cover: false, type: '', widget: MWBottomNavigationScreen2(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'With Shifting Label', show_cover: false, type: '', widget: MWBottomNavigationScreen3(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
List<ProTheme> getDrawer() {
  ...
  list.add(ProTheme(
      ...
      isWebSupported: true));
  list.add(
      ProTheme(name: 'With Custom Shape ', show_cover: false, type: '', widget: MWDrawerScreen2(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Drawer 3', show_cover: false, type: '', tag: '', widget: MWDrawerScreen3(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Drawer 4', show_cover: false, type: '', tag: '', widget: MWDrawerScreen4(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Drawer 5', show_cover: false, type: '', tag: '', widget: MWDrawerScreen5(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getSliverAppBar() {
  ...
  list.add(ProTheme(
      ...
      isWebSupported: true));
  list.add(ProTheme(
      name: 'Parallax Sliver AppBar', show_cover: false, type: '', widget: MWSliverAppBarScreen2(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getTabBar() {
  ...
  list.add(ProTheme(
      name: 'TabBar with Title and Icon', show_cover: false, type: '', widget: MWTabBarScreen2(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'TabBar with Icon', show_cover: false, type: '', widget: MWTabBarScreen3(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getButtons() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'DropDownButton', show_cover: false, type: '', widget: MWDropDownButtonScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'MaterialButton', show_cover: false, type: '', widget: MWMaterialButtonScreen(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(
      ProTheme(name: 'OutlineButton', show_cover: false, type: '', widget: MWOutlineButtonScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'PopupMenuButton', show_cover: false, type: '', widget: MWPopupMenuButtonScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'RaisedButton', show_cover: false, type: '', widget: MWRaisedButtonScreen(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getInputSelection() {
  ...
  list.add(ProTheme(
      name: 'Datetime Picker', show_cover: false, type: '', widget: MWDatetimePickerScreen(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(
      ProTheme(name: 'TextFormField', show_cover: false, type: '', widget: MWTextFormFieldScreen(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getTextField() {
  List<ProTheme> list = [];
  list.add(
      ProTheme(name: 'Simple TextField ', show_cover: false, type: '', widget: MWTextFieldScreen1(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Rounded Border TextField ', show_cover: false, type: '', widget: MWTextFieldScreen2(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getDialogs() {
  ...
  list.add(ProTheme(
      name: 'BottomSheet', show_cover: false, type: '', tag: '', widget: MWBottomSheetScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'ExpansionPanel',
      show_cover: false,
      type: '',
      ...
      isWebSupported: true));
  list.add(
      ProTheme(name: 'Simple Dialog', show_cover: false, type: '', widget: MWSimpleDialogScreen(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getInformationDisplay() {
  ...
  list.add(
      ProTheme(name: 'Progress Bar', show_cover: false, type: '', widget: MWProgressBarScreen(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getListView() {
  List<ProTheme> list = [];
  list.add(
      ProTheme(name: 'Simple List View', show_cover: false, type: '', widget: MWListViewScreen1(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'List Wheel ScrollView', show_cover: false, type: '', widget: MWListViewScreen2(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Horizontal List View', show_cover: false, type: '', widget: MWListViewScreen3(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Bouncing Scroll List View', show_cover: false, type: '', widget: MWListViewScreen4(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Reorderable List View', show_cover: false, type: '', widget: MWListViewScreen5(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getStepper() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'Horizontal Stepper with Form', show_cover: false, type: '', widget: MWStepperScreen1(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Vertical Stepper', show_cover: false, type: '', widget: MWStepperScreen2(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Vertical Stepper with Form', show_cover: false, type: '', widget: MWStepperScreen3(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Simple Horizontal Stepper', show_cover: false, type: '', widget: MWStepperScreen4(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getExpansionPanelList() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'Expansion Panel 1', show_cover: false, type: '', widget: MWExpansionPanelScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
List<ProTheme> getCupertinoWidgets() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'Cupertino Action Sheet', show_cover: false, type: '', widget: CWActionSheetScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      ...
      isWebSupported: true));
  list.add(ProTheme(
      name: 'Cupertino Alert Dialog', show_cover: false, type: '', widget: CWAlertDialogScreen(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(ProTheme(
      name: 'Cupertino Context Menu', show_cover: false, type: '', widget: CWContextMenuScreen(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(ProTheme(
      name: 'Cupertino TabBar', show_cover: false, type: '', sub_kits: getCupertinoTabBar(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Cupertino TextField', show_cover: false, type: '', widget: CWTextFieldScreen(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getCupertinoTabBar() {
  List<ProTheme> list = [];
  list.add(
      ProTheme(name: 'Tab Bar with Icon ', show_cover: false, type: '', widget: CWTabBarScreen1(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Tab Bar with Icon and Label ', show_cover: false, type: '', widget: CWTabBarScreen2(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Tab Bar with Custom Image ', show_cover: false, type: '', widget: CWTabBarScreen3(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getPaintingAndEffectWidgets() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'Backdrop Filter', show_cover: false, type: '', widget: PEBackdropFilterScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Clip Widget Demo', show_cover: false, type: '', widget: PEClipOvalScreen(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getAnimationAndMotionWidgets() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'Animated Builder', show_cover: false, type: '', widget: AMAnimatedBuilderScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Animated Container', show_cover: false, type: '', widget: AMAnimatedContainerScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Animated Cross Fade', show_cover: false, type: '', widget: AMAnimatedCrossFadeScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Animated Opacity', show_cover: false, type: '', widget: AMAnimatedOpacityScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Fade Transition', show_cover: false, type: '', widget: AMFadeTransitionScreen(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(ProTheme(
      name: 'Scale Transition', show_cover: false, type: '', widget: AMScaleTransitionScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Animated Size', show_cover: false, type: '', widget: AMAnimatedSizeScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
List<ProTheme> getInteractionModelWidgets() {
  ...
  list.add(ProTheme(
      name: 'Gesture Detector', show_cover: false, type: '', widget: IMGestureDetectorScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Draggable', show_cover: false, type: '', sub_kits: getDraggable(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Long Press Draggable', show_cover: false, type: '', sub_kits: getLongPressDraggable(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getDraggable() {
  List<ProTheme> list = [];
  list.add(
      ProTheme(name: 'Simple Draggable', show_cover: false, type: '', widget: IMDraggableScreen1(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Draggable with Target', show_cover: false, type: '', widget: IMDraggableScreen2(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getOtherWidgets() {
  List<ProTheme> list = [];
  list.add(ProTheme(
      name: 'Interactive Viewer', show_cover: false, type: '', widget: InteractiveViewerScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
ProTheme getIntegrations() {
  ...
  list.add(ProTheme(
      name: 'Generate QR Code', title_name: 'Integrations', show_cover: false, widget: GenerateQRCodeScreen(), darkThemeSupported: true, tag: ''));
  list.add(
      ProTheme(name: 'PDF Viewer', title_name: 'Integrations', show_cover: false, sub_kits: getPdfListScreen(), darkThemeSupported: true, tag: ''));
  list.add(
      ProTheme(name: 'Firebase CRUD', title_name: 'Integrations', show_cover: false, widget: FUserListScreen(), darkThemeSupported: true, type: ''));
  ...
  list.add(
      ProTheme(name: 'Payment Gateways', title_name: 'Integrations', type: '', show_cover: false, sub_kits: getPayment(), darkThemeSupported: true));
  list.add(ProTheme(
      name: 'Rest API Integration', title_name: 'Integrations', type: '', show_cover: false, sub_kits: getRestAPi(), darkThemeSupported: true));
...
List<ProTheme> getIntegration() {
  ...
  list.add(ProTheme(
      name: 'Local Notification', show_cover: false, type: '', widget: LocalNotificationScreen(), darkThemeSupported: true, isWebSupported: false));
  list.add(ProTheme(
  ...
  list.add(ProTheme(
      name: 'Before After Image', show_cover: false, type: '', widget: BeforeAfterImageScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Google Sign In', show_cover: false, type: '', widget: GoogleSignInScreen(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(ProTheme(
      name: 'Liquid Swipe WalkThrough', show_cover: false, type: '', widget: LiquidSwipeScreen(), darkThemeSupported: true, isWebSupported: false));
...
List<ProTheme> getLists() {
  ...
  list.add(ProTheme(
      ...
      isWebSupported: true));
  list.add(ProTheme(
      name: 'Folding Cell in ListView', type: '', show_cover: false, widget: FoldingCellScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Shimmer', type: '', show_cover: false, widget: SHomePage(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Sticky Header', type: '', show_cover: false, sub_kits: getSubStickyHeader(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getSubStickyHeader() {
  ...
  list.add(
      ProTheme(name: 'Header and Content', type: '', show_cover: false, widget: SimpleHeaders(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Animated Headers with Content', type: '', show_cover: false, widget: AnimatedHeaders(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
...
List<ProTheme> getPayment() {
  ...
  list.add(
      ProTheme(name: 'RazorPay Payment', type: '', show_cover: false, widget: RazorPayScreen(), darkThemeSupported: true, isWebSupported: false));
  /*list.add(
    ProTheme(
      name: 'Stripe Payment',
      type: '',
...
List<ProTheme> getRestAPi() {
  ...
  list.add(ProTheme(
      ...
      isWebSupported: true));
  list.add(
      ProTheme(name: 'Post example', type: '', show_cover: false, widget: PostMethodExampleScreen(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getWebDashboard() {
  ...
  list.add(ProTheme(
      ...
      tag: 'New',
      show_cover: false,
      widget: Responsive(web: HomeScreen(), mobile: HomeScreenMobile(), tablet: HomeScreenTablet()),
      darkThemeSupported: false,
      isWebSupported: true));
  list.add(
      ProTheme(name: 'Dashboard 3', tag: 'New', show_cover: false, widget: Dashboard3HomeScreen(), darkThemeSupported: false, isWebSupported: true));
...
List<ProTheme> getChartList() {
  ...
  list.add(ProTheme(
      name: 'Monthly Sale Chart1', tag: '', show_cover: false, widget: MonthlySale1Screen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(
      name: 'Monthly Sale Chart2', tag: '', show_cover: false, widget: MonthlySale2Screen(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(
      ProTheme(name: 'Transaction Chart', tag: '', show_cover: false, widget: TransactionScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Stacked Chart 1', tag: '', show_cover: false, widget: StackedChart1Screen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Stacked Chart 2', tag: '', show_cover: false, widget: StackedChart2Screen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Stacked Chart 3', tag: '', show_cover: false, widget: StackedChart3Screen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Stacked Chart 4', tag: '', show_cover: false, widget: StackedChart4Screen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Stacked Chart 5', tag: '', show_cover: false, widget: StackedChart5Screen(), darkThemeSupported: true, isWebSupported: true));
  list.add(
      ProTheme(name: 'Stacked Chart 6', tag: '', show_cover: false, widget: StackedChart6Screen(), darkThemeSupported: true, isWebSupported: true));
